...
export default function IndexPage({ posts }) {
  ...
  <div className="mycontainer mt-5">
            ...
            <div className="row">
              ...
              <div className="col-lg-7 mx-auto my-auto">
                ...
                <div className="row mt-3 container">
                  ...
                  <p style={{fontSize: '12px'}} className="text-dark ml-1 my-auto mr-3">2 jam yang lalu</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="footer container mt-5">
      <div className="row justify-content-center text-center mt-3 mb-4" style={{fontSize: '.875em'}}>
...
export async function getServerSideProps({params}) {
  const res = await fetch(
    "http://localhost:8000/api/berita/kategori/" + params.kategori
  );
